...
[ExcludeClass]
internal class _SQLExceptionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("SQLState", "message", "localizedMessage", "cause", "errorCode", "nextException", "stackTrace");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("SQLState", "message", "localizedMessage", "cause", "errorCode", "nextException", "stackTrace");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("SQLState", "message", "localizedMessage", "cause", "errorCode", "nextException", "stackTrace");
    ...
    model_internal var _instance:_Super_SQLException;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();
    
    public function _SQLExceptionEntityMetadata(sQLException : _Super_SQLException)
    {
        ...
        model_internal::_instance = sQLException;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity SQLException");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity SQLException");  
     ...
     override public function getValue(propertyName:String):*    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity SQLException");
         }     
