...
internal class _ConnectionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("autoCommit", "readOnly", "holdability", "typeMap", "catalog", "closed", "transactionIsolation", "clientInfo", "warnings", "metaData");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("autoCommit", "readOnly", "holdability", "typeMap", "catalog", "closed", "transactionIsolation", "clientInfo", "warnings", "metaData");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("autoCommit", "readOnly", "holdability", "typeMap", "catalog", "closed", "transactionIsolation", "clientInfo", "warnings", "metaData");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("autoCommit", "readOnly", "holdability", "typeMap", "catalog", "closed", "transactionIsolation", "clientInfo", "warnings", "metaData");
    ...
    public function _ConnectionEntityMetadata(connection : _Super_Connection)
    {
        ...
        model_internal::_instance = connection;     
    }
