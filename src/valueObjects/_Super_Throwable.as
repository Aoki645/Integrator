 ...
 * of this value object you may modify the generated sub-class of this class - Throwable.as.
 */
...
[ExcludeClass]
public class _Super_Throwable extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("java.lang.Throwable") == null)
            {
                flash.net.registerClassAlias("java.lang.Throwable", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	model_internal var _dminternal_model : _ThrowableEntityMetadata;
	...
	public function _Super_Throwable() 
	{	
		_model = new _ThrowableEntityMetadata(this);
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    [Transient] 
	[Bindable(event="propertyChange")] 
    public function get _model() : _ThrowableEntityMetadata
    {
		return model_internal::_dminternal_model;              
    }	
    
    public function set _model(value : _ThrowableEntityMetadata) : void       
    {
    	var oldValue : _ThrowableEntityMetadata = model_internal::_dminternal_model;               
        if (oldValue !== value)
        {
