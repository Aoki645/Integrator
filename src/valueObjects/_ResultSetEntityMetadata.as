...
internal class _ResultSetEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("fetchSize", "holdability", "last", "beforeFirst", "type", "cursorName", "row", "statement", "fetchDirection", "afterLast", "concurrency", "closed", "warnings", "first", "metaData");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("fetchSize", "holdability", "last", "beforeFirst", "type", "cursorName", "row", "statement", "fetchDirection", "afterLast", "concurrency", "closed", "warnings", "first", "metaData");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("fetchSize", "holdability", "last", "beforeFirst", "type", "cursorName", "row", "statement", "fetchDirection", "afterLast", "concurrency", "closed", "warnings", "first", "metaData");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("fetchSize", "holdability", "last", "beforeFirst", "type", "cursorName", "row", "statement", "fetchDirection", "afterLast", "concurrency", "closed", "warnings", "first", "metaData");
    ...
    public function _ResultSetEntityMetadata(resultSet : _Super_ResultSet)
    {
        ...
        model_internal::_instance = resultSet;     
    }
